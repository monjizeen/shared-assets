...
**Canonical source:** `monjizeen` repo — components + `.cursor/rules/design.mdc`  
...
4. Follow tokens/rules in `monjizeen/.cursor/rules/design.mdc` (colors, RTL, typography, motion).
